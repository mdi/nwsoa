...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.radar_server(id, reporting_host=reporting_host)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.radar_servers(reporting_host=reporting_host)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.radar_station(station_id, reporting_host=reporting_host, host=host)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.radar_station_alarms(station_id)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.radar_stations(station_type=station_type, reporting_host=reporting_host, host=host)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.satellite_thumbnails(area)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sigmet(atsu, var_date, time)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sigmet_query(start=start, end=end, var_date=var_date, atsu=atsu, sequence=sequence)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sigmets_by_atsu(atsu)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sigmets_by_atsuby_date(atsu, var_date)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.station_observation_latest(station_id, require_qc=require_qc)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.station_observation_list(station_id, start=start, end=end, limit=limit)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.station_observation_time(station_id, time)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.taf(station_id, var_date, time)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.tafs(station_id)
...
with nwsoa.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = nwsoa.DefaultApi(api_client)
    type = nwsoa.NWSZoneType() # NWSZoneType | Zone type
    zone_id = 'zone_id_example' # str | NWS public zone/county identifier
    effective = '2013-10-20T19:20:30+01:00' # datetime | Effective date/time (optional)

    try:
        api_response = api_instance.zone(type, zone_id, effective=effective)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.zone_forecast(type, zone_id)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    area = [nwsoa.AreaCode()] # List[AreaCode] | State/marine area code (optional)
    region = [nwsoa.RegionCode()] # List[RegionCode] | Region code (optional)
    type = [nwsoa.NWSZoneType()] # List[NWSZoneType] | Zone type (optional)
    ...
    try:
        api_response = api_instance.zone_list(id=id, area=area, region=region, type=type, point=point, include_geometry=include_geometry, limit=limit, effective=effective)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    area = [nwsoa.AreaCode()] # List[AreaCode] | State/marine area code (optional)
    region = [nwsoa.RegionCode()] # List[RegionCode] | Region code (optional)
    type2 = [nwsoa.NWSZoneType()] # List[NWSZoneType] | Zone type (optional)
    point = 'point_example' # str | Point (latitude,longitude) (optional)
    include_geometry = True # bool | Include geometry in results (true/false) (optional)
    limit = 56 # int | Limit (optional)
    effective = '2013-10-20T19:20:30+01:00' # datetime | Effective date/time (optional)
    ...
    try:
        api_response = api_instance.zone_list_type(type, id=id, area=area, region=region, type2=type2, point=point, include_geometry=include_geometry, limit=limit, effective=effective)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.zone_obs(zone_id, start=start, end=end, limit=limit)
...
with nwsoa.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.zone_stations(zone_id, limit=limit, cursor=cursor)
