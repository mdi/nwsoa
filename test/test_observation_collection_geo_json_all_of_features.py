...
class TestObservationCollectionGeoJsonAllOfFeatures(unittest.TestCase):
    """ObservationCollectionGeoJsonAllOfFeatures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationCollectionGeoJsonAllOfFeatures:
        """Test ObservationCollectionGeoJsonAllOfFeatures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObservationCollectionGeoJsonAllOfFeatures`
        """
        model = ObservationCollectionGeoJsonAllOfFeatures()
        if include_optional:
            return ObservationCollectionGeoJsonAllOfFeatures(
                properties = nwsoa.models.observation.Observation(
                    @context = null, 
                    geometry = '', 
                    @id = '', 
    ...
    def testObservationCollectionGeoJsonAllOfFeatures(self):
        """Test ObservationCollectionGeoJsonAllOfFeatures"""
