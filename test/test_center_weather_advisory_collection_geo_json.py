    ...
    def make_instance(self, include_optional) -> CenterWeatherAdvisoryCollectionGeoJson:
        ...
        if include_optional:
            return CenterWeatherAdvisoryCollectionGeoJson(
                ...
                features = [
                    nwsoa.models.center_weather_advisory_collection_geo_json_all_of_features.CenterWeatherAdvisoryCollectionGeoJson_allOf_features(
                        properties = nwsoa.models.center_weather_advisory.CenterWeatherAdvisory(
                            id = '', 
