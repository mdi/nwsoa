    ...
    def make_instance(self, include_optional) -> PointRelativeLocation:
        ...
        if include_optional:
            return PointRelativeLocation(
                ...
                type = 'Feature',
                geometry = '',
                properties = nwsoa.models.relative_location.RelativeLocation(
                    city = '', 
                    state = '', 
                    distance = nwsoa.models.quantitative_value.QuantitativeValue(
                        value = 1.337, 
                        max_value = 1.337, 
                        min_value = 1.337, 
                        unit_code = 'nwsUnit:R,rZ#UM/?R,Fp^l6$ARjbhJk C>i H\'qT\\{<?\'es#)#iK.YM{Rag2/!KB!k@5oXh.:', 
                        quality_control = 'Z', ), 
                    bearing = nwsoa.models.quantitative_value.QuantitativeValue(
                        value = 1.337, 
                        max_value = 1.337, 
                        min_value = 1.337, 
                        unit_code = 'nwsUnit:R,rZ#UM/?R,Fp^l6$ARjbhJk C>i H\'qT\\{<?\'es#)#iK.YM{Rag2/!KB!k@5oXh.:', 
