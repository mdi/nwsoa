    ...
    def make_instance(self, include_optional) -> AlertCollectionGeoJson:
        ...
        if include_optional:
            return AlertCollectionGeoJson(
                ...
                features = [
                    nwsoa.models.alert_collection_geo_json_all_of_features.AlertCollectionGeoJson_allOf_features(
                        properties = nwsoa.models.alert.Alert(
                            id = '', 
                            area_desc = '', 
                            geocode = nwsoa.models.alert_geocode.Alert_geocode(
                                ugc = [
                                    'UTZ807'
                                    ], 
                                same = [
                            ...
                            references = [
                                nwsoa.models.alert_references_inner.Alert_references_inner(
                                    @id = '', 
                                    identifier = '', 
                                    sender = '', 
                ...
                pagination = nwsoa.models.pagination_info.PaginationInfo(
                    next = '', )
            )
        else:
            return AlertCollectionGeoJson(
