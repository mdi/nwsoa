    ...
    def make_instance(self, include_optional) -> AlertAtomFeed:
        ...
        if include_optional:
            return AlertAtomFeed(
                ...
                generator = '',
                updated = '',
                author = nwsoa.models.alert_atom_feed_author.AlertAtomFeed_author(
                    name = '', ),
                title = '',
                entry = [
                    nwsoa.models.alert_atom_entry.AlertAtomEntry(
                        id = '', 
                        updated = '', 
                        published = '', 
                        author = nwsoa.models.alert_atom_entry_author.AlertAtomEntry_author(
                            name = '', ), 
                        summary = '', 
                        event = '', 
                        sent = '', 
                        ...
                        polygon = '', 
                        geocode = [
                            nwsoa.models.alert_xml_parameter.AlertXMLParameter(
                                value_name = '', 
                                value = '', )
                            ], 
                        parameter = [
