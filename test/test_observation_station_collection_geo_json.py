    ...
    def make_instance(self, include_optional) -> ObservationStationCollectionGeoJson:
        ...
        if include_optional:
            return ObservationStationCollectionGeoJson(
                ...
                features = [
                    nwsoa.models.observation_station_collection_geo_json_all_of_features.ObservationStationCollectionGeoJson_allOf_features(
                        properties = nwsoa.models.observation_station.ObservationStation(
                            @context = null, 
                            geometry = '', 
                            @id = '', 
