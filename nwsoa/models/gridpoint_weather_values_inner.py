...
class GridpointWeatherValuesInner(BaseModel):
    """
    GridpointWeatherValuesInner
    """ # noqa: E501
    valid_time: ISO8601Interval = Field(alias="validTime")
    value: List[GridpointWeatherValuesInnerValueInner]
    __properties: ClassVar[List[str]] = ["validTime", "value"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of valid_time
        if self.valid_time:
            _dict['validTime'] = self.valid_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validTime": ISO8601Interval.from_dict(obj["validTime"]) if obj.get("validTime") is not None else None,
            "value": [GridpointWeatherValuesInnerValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
