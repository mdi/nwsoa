...
class AlertCollectionGeoJson(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "type", "features", "title", "updated", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "features": [AlertCollectionGeoJsonAllOfFeatures.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None,
            "title": obj.get("title"),
