...
class CenterWeatherAdvisoryCollectionGeoJson(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "type", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "features": [CenterWeatherAdvisoryCollectionGeoJsonAllOfFeatures.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
