    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.present_weather:
            for _item_present_weather in self.present_weather:
                if _item_present_weather:
                    _items.append(_item_present_weather.to_dict())
        ...
        if self.cloud_layers:
            for _item_cloud_layers in self.cloud_layers:
                if _item_cloud_layers:
                    _items.append(_item_cloud_layers.to_dict())
