...
class TextProductTypeCollection(BaseModel):
    ...
    graph: Optional[List[TextProductTypeCollectionGraphInner]] = Field(default=None, alias="@graph")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@graph": [TextProductTypeCollectionGraphInner.from_dict(_item) for _item in obj["@graph"]] if obj.get("@graph") is not None else None
        })
        return _obj
