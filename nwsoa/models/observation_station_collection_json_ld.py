...
class ObservationStationCollectionJsonLd(BaseModel):
    ...
    graph: Optional[List[ObservationStation]] = Field(default=None, alias="@graph")
    observation_stations: Optional[List[StrictStr]] = Field(default=None, alias="observationStations")
    pagination: Optional[PaginationInfo] = None
    __properties: ClassVar[List[str]] = ["@context", "@graph", "observationStations", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@graph": [ObservationStation.from_dict(_item) for _item in obj["@graph"]] if obj.get("@graph") is not None else None,
