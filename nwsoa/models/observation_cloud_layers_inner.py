...
class ObservationCloudLayersInner(BaseModel):
    """
    ObservationCloudLayersInner
    """ # noqa: E501
    base: QuantitativeValue
    amount: MetarSkyCoverage
    __properties: ClassVar[List[str]] = ["base", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base": QuantitativeValue.from_dict(obj["base"]) if obj.get("base") is not None else None,
